...
public class MemberDao {
	...
	public int getListCount(Connection con) throws MemberException {
		int listCount = 0;
		Statement stmt = null;
		ResultSet rset = null;
	...
	public ArrayList<Member> selectList(Connection con, int currentPage, int limit) throws MemberException {
	...
	public ArrayList<Member> filterSearch(Connection con, String filter, String value) throws MemberException {
		//필터 회원 검색
				ArrayList<Member> list = new ArrayList<Member>();
				PreparedStatement pstmt = null;
				ResultSet rset = null;
				...
				switch(filter){
				case "이름": query += "where m_name = ?"; break;
				case "아이디": query += "where m_id = ?"; break;
				case "닉네임": query += "where m_nickname = ?"; break;
				case "전화번호": query += "where m_phone = ?"; break;
	...
	public int editMember(Connection con, Member m) throws MemberException {
		int result = 0;
		PreparedStatement pstmt = null;
