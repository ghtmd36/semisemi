...
<script type="text/javascript">
	function localsubmit(){
		location.href="/semi/plocalsearch";	
	};
	$(function(){
	var local = $("#localSelect option:selected").val();
	});
</script>
                            ...
                            <form action="/semi/psearch" class=" form-inline">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">                                   
                                        ...
                                        onchange="localsubmit();" id="localSelect" name="localSelect">
